      ...
      <>
        <div className="font-sans bg-background text-foreground min-h-screen relative">
            ...
            <div className="max-w-3xl mx-auto flex flex-col items-center justify-center h-[80vh] text-center px-4">
                ...
                <a
                    href="/"
                    className="mt-6 px-5 py-2 rounded-md border border-[#2F4F3E] dark:border-[#2F4F3E] text-gray-800 dark:text-gray-600 dark:hover:text-gray-200 hover:bg-[#2F4F3E] dark:hover:bg-[#2F4F3E] transition-colors duration-200"
                >
                    ← Back to Home
                </a>
            </div>
