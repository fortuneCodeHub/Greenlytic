            ...
            {!loading && paginatedArticles.length > 0 ? (
              paginatedArticles.map((post) => (
                <article
                  ...
                  className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all hover:border-2 overflow-hidden flex flex-col md:flex-row hover:border-[#3A82F7] cursor-pointer"
                >
                  {/* IMAGE */}
                  ...
                  <div className="p-5 flex flex-col justify-between md:w-2/3">
                    <div>
                      ...
                      <h3 className="mt-3 text-lg font-semibold text-slate-900 hover:text-[#3A82F7] leading-tight">
                    ...
                    <div className="mt-4 flex items-center justify-between text-xs text-slate-500">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        >
                          {bookmarked[post._id] ? (
                            <svg className="h-5 w-5 text-[#3A82F7]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="space-y-4">
              {popularPosts?.length > 0 ? (
                popularPosts.map((p) => (
                  ...
                  >
                    <p className="text-sm font-medium text-slate-800 group-hover:text-[#3A82F7] transition leading-snug">
