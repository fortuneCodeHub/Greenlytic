...
export default function Hero({ posts, loading }) {
  return (
    <section className="max-w-8xl mx-auto px-4 mt-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              >
                <Link href={`/post/${post.slug}`}>
                  ...
                  <div className="absolute bottom-0 p-6 text-white">
                    ...
                    <div className="mt-3 w-20 h-[3px] bg-[#3A82F7] rounded-full"></div>
                  </div>
                </Link>
              </div>
            ))}
              ...
              >
                <Link href={`/post/${post.slug}`}>
                  ...
                  <div className="absolute bottom-0 p-4 text-white">
                    ...
                    <div className="mt-2 w-16 h-[3px] bg-[#3A82F7] rounded-full"></div>
                  </div>
                </Link>
              </div>
            ))}
