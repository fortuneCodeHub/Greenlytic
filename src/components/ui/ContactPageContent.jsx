...
export default function ContactPageContent() {
  ...
  return (
    <>
        ...
        <section className="relative flex items-center justify-center min-h-screen py-20 px-6 bg-[#2F4F3E] text white">
        ...
        <div className="max-w-2xl w-full bg-white border border-gray-200 rounded-2xl shadow-md p-8">
            ...
            <h1 className="text-4xl font-bold mb-3 text-gray-900 flex md:flex-row flex-col items-center justify-center">
                Contact
                <Link href="/" className="relative lg:text-5xl md:text-4xl ms-5 text-2xl font-extrabold">
            ...
            <div>
                ...
                required
                className="w-full px-4 py-3 rounded-lg bg-white border border-gray-300 text-gray-900 focus:ring-2 focus:ring-[#2F4F3E] outline-none transition"
                />
            </div>
            ...
            <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 bg-[#2F4F3E] text-white font-semibold text-lg rounded-lg shadow-md hover:bg-[#243D31] focus:ring-2 focus:ring-[#2F4F3E]/60 disabled:opacity-60 transition-all"
            >
